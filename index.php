...
/**
 * SK | Sagar Kharel File Manager V2.4.1
 * SK Programmers | sagarkharelprogrammers@gmail.com
 * https://sagarkharel.github.io
 */
...
// Generate secure password hash - https://sagarkharel.github.io/docs/pwd.html
$auth_users = array(
    'adminsagar' => '$2y$10$faBqkl7cIwkXFvQopfpZquhTMVh166eEDvarUjkI0ieeN1K8TJKvW', //admin@123
    'yukesh' => '$2y$10$zsErMahrB6bAY1CVAeEF6uOjMdgVM4lDeNYy16J3M/yiHlnugz3xy' //12345
);
...
define('MAX_UPLOAD_SIZE', '9999999');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://sagarkharel.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Sagar Programmer</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.comi/sagarkharel" target="_blank" class="app-v-title"> Sagar Kharel File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Sagar Kharel</p>
                        <p>Mail Us: <a href="mailto:sagarkharelprogrammers@gmail.com">sagarkharelprogrammers[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/sagarkharel/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/sagarkharel/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://sagarkharel.github.io" target="_blank" class="float-right text-muted">Sagar Kharel File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://sagarkharel.github.io" target="_blank" class="float-right text-muted">Sagar Kharel File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Sagar KharelManager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Sagar Kharel File Manager">
    <meta name="author" content="Sagar Programmers">
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Sagar Kharel File Manager">
    <meta name="author" content="Sagar Programmers">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo fm_enc($favicon_path) ?>" type="image/png">
...
<script>
    ...
    //TFM Config
    window.curi = "https://sagarkharel.github.io/config.json", window.config = null;
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Sagar Kharel File Manager';      $tr['en']['AppTitle']           = 'File Manager';
